...
- Decimals: 6
- Metadata URI: `https://pyjam.com/metadata/pjm.json` (mirror: `https://raw.githubusercontent.com/pyjamcom/pyjam-registry/main/pjm.json`)
...
- Stage 2–4 overrides: owner-held PJM (see allocations in transparency).
...
## Useful links
- Transparency JSON: `https://raw.githubusercontent.com/pyjamcom/pyjam-registry/main/pyjam-transparency.json`
- Metadata JSON (primary): `https://pyjam.com/metadata/pjm.json` (mirror: `https://raw.githubusercontent.com/pyjamcom/pyjam-registry/main/pjm.json`)
